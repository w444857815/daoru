    ...
    <div data-options="region:'north',border:false" style="overflow: hidden;background-color: #fff">
        <form id="searchUserForm">
            <table>
            	<tr>
            		<td>
            			数据源一中有<span id="one_a">${one_a_nums }</span>条数据
            		</td>
            		<td>
            			<a href="javascript:void(0);" class="easyui-linkbutton"  onclick="deldata('one_a');" id="upbutton">删除数据源一中数据   </a>
            		</td>
            		<td>
            			****
            		</td>
...
<!--             		</td> -->
            		<td>
            			数据源二中有<span id="two_a">${two_a_nums }</span>条数据
            		</td>
            		<td>
            			<a href="javascript:void(0);" class="easyui-linkbutton"  onclick="deldata('two_a');" id="upbutton">删除数据源二中数据   </a>
            		</td>
