...
<!-- 	</form> -->
	...
	<form id="edui_form_j1xc1nj4" method="POST" enctype="multipart/form-data" action="/shiro/files/daoruKfdMx?action=uploadfile" >
		<input id="edui_input_j1xc1nj4" accept="application/vnd.ms-excel" name="upfile" 
