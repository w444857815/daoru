...
public abstract class BaseController {
    ...
    public <T> Page<T> getPage(PageInfo pageInfo){
        Page<T> page = new Page<T>(pageInfo.getNowpage(), pageInfo.getSize(), pageInfo.getSort());
	 ...
	 * @throws Exception
	 */
	public ModelAndView success(String message) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ModelAndView fail(String message) throws Exception {
		return new ModelAndView("/fail", "message", message);
	}
	 ...
	 * @return
	 */
	public String getMainLeftHtml(HttpServletRequest request) {
		return "";
	}
